...
if st.button("Submit"):
    ...
    df_new_respondant_result = pd.DataFrame([enriched_data], columns=["FullName", "Email", "TotalScore", "CategoryScores", "BestCategory", "WorstCategory", "BestCategoryScore", "WorstCategoryScore"])
    
    # Display the results dataframe
    st.dataframe(df_new_respondant_result)

    st.title("Category Scores Visualization")
